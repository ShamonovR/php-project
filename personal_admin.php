...
<script type="text/javascript">
    ...
    if (pass=='123') ;
        ...
        top.location.href="personal.php"; 
    }
    -->
</script>
  <script>
...
<div class="container">
    ...
    <a class="create_tovar" href="add_user.php">
        ...
        $userdata = mysqli_fetch_assoc($query); 
            if  ($userdata["user_group"]   >= 3 ){ 
                echo   ' <a class="create_tovar" href="personal.php">
        <button type="button" class="knopka btn   btn-outline-primary">Назад</button>
        </a>';
 ...
 <?
  ...
  $query ="SELECT users.user_id, users.user_login, users.user_password, users.user_surname, groups.name as groups FROM users INNER JOIN groups ON groups.groups_id = users.user_group where user_group >= 3 ORDER BY user_group DESC";
